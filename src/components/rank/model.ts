...
export const rankDays: Rank[] = [
    ...
    },
    {
        name: '5855',
        invite: 102,
        avatar: 'https://img1.baidu.com/it/u=3456131452,327404300&fm=253&fmt=auto&app=120&f=JPEG?w=640&h=360'
    },
    {
        name: '用户471006659809',
        invite: 752,
    ...
    },
    {
        name: '微信用户',
        invite: 42,
        avatar: 'https://img2.baidu.com/it/u=2445182967,1362518192&fm=253&fmt=auto&app=120&f=JPEG?w=640&h=360'
    },
    {
        name: '抽象的生活',
        invite: 10,
